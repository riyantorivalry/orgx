...
export const adminHomeStyles = StyleSheet.create({
  ...
  dateTimeLabel: { color: "#5b7092", fontSize: 11, fontWeight: "700" },
  dateTimeValue: { marginTop: 2, color: "#1f3f74", fontSize: 13, fontWeight: "800" },
  dateTimeInput: {
    marginTop: 3,
    borderWidth: 1,
    borderColor: "#d2dff2",
  ...
  pickerWrap: { marginTop: 8, gap: 8, alignItems: "flex-end" },
  currentSessionPanel: {
    borderWidth: 1,
    borderColor: "#c6d9f5",
    borderRadius: 12,
